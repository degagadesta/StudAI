        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 text-left flex flex-col gap-5">
            ...
            <p className="text-sm sm:text-base text-brand-text-muted leading-relaxed">
              Ask questions and get answers grounded in your actual lecture
              materials, course syllabus, and previous exams. No more generic
              search templates.
            </p>
            ...
            <div className="flex flex-col gap-3 mt-4">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-3 text-xs sm:text-sm text-brand-text"
                >
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-brand-bg-darker/60 p-2 shadow-[0_30px_100px_rgba(0,0,0,0.6)] backdrop-blur-xl transition-all duration-500 hover:border-brand-primary/20 group">
              ...
              {/* Image */}
              <div className="overflow-hidden rounded-xl border border-white/5 mt-2">
                <img
                  src={aiChat}
