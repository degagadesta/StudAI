...
export const getCourses = async (req, res, next) => {
    try {
        ...
        const courses = await courseService.getStudentCourses(req.studentId, searchQuery);
...
export const addCourseSelection = asyncHandler(async (req, res) => {
    ...
    const result = await courseService.addCourseSelection(req.studentId, curriculumCourseId);
...
export const dropCourseSelection = asyncHandler(async (req, res) => {
    ...
    const result = await courseService.dropCourseSelection(req.studentId, curriculumCourseId);
