      ...
      <header className="flex items-center justify-between gap-6 px-8 pt-8 pb-6">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            aria-label="Settings"
            className="w-11 h-11 rounded-full bg-[#FFFDF7] border border-[#DCD2B4] flex items-center justify-center text-[#5B6156] hover:bg-[#EFE8D4] transition-colors cursor-pointer"
          >
